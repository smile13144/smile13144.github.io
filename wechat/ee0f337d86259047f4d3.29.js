...
exports.default = {
    ...
    methods: {
        loadDetail: function loadDetail(id) {
            var _this = this;
            _this.post(_this.api.trainTeacherDetails, { 'teacher_id': id }, 'sid').then(function (res) {
                if (res.ok) {
                    _this.teacher = res.body.data;
                }
            }, function (res) {});
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('not-list-scroll', {
    staticClass: "teacher-detail-page"
  }, [_c('div', {
    staticClass: "top-header-div"
  }, [_c('div', {
    ...
    slot: "icon"
  })]), _vm._v(" "), (_vm.teacher.sex === '1') ? _c('div', [_c('img', {
    attrs: {
      "src": _vm._f("getCoverUrl")(_vm.teacher.head_photo, 'teacherMan')
    }
  })]) : (_vm.teacher.sex === '2') ? _c('div', [_c('img', {
    attrs: {
      "src": _vm._f("getCoverUrl")(_vm.teacher.head_photo, 'teacherWoman')
    }
  })]) : _c('div', [_c('img', {
    attrs: {
      "src": _vm._f("getCoverUrl")(_vm.teacher.head_photo, 'teacher')
    }
  })]), _vm._v(" "), _c('a', {
    staticClass: "name"
  }, [_vm._v(_vm._s(_vm.teacher.name))])]), _vm._v(" "), _c('div', {
    staticClass: "teacher-description"
  }, [(_vm.teacher.brief === '') ? [_vm._v("暂无个人说明")] : [_vm._v(_vm._s(_vm.teacher.brief))]], 2)])], 1)
},staticRenderFns: []}

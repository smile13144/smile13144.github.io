...
exports.default = {
    ...
    filters: {
        surveyStatus: function surveyStatus(status) {
            if (status === '0') {
                return "开始调研";
            } else {
                return "查看详情";
    ...
    created: function created() {
        var _this = this;
        _this.surveyInfo = JSON.parse(localStorage.surveyInfo);
    },
    ...
    methods: {
        ...
        detailButtonAction: function detailButtonAction() {
            localStorage.htmlURL = (0, _stringify2.default)(this.surveyInfo.paper_url);
            this.$router.push("/htmlPlay");
        }
    },
    ...
    computed: (0, _extends3.default)({}, (0, _vuex.mapState)(['surveyStore'])),
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('not-list-scroll', {
    staticClass: "survey-detail"
  }, [_c('div', {
    staticClass: "survey-detail-top-div"
  }, [_c('div', {
    ...
    attrs: {
      "src": _vm._f("getCoverUrl")(_vm.surveyInfo.cover, 'research')
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "survey-detail-bottom-div"
  }, [_c('p', {
    staticClass: "survey-detail title"
  }, [_vm._v(_vm._s(_vm.surveyInfo.name))]), _vm._v(" "), _c('p', {
    staticClass: "survey-detail description-font begin-time"
  }, [_vm._v("开始时间: " + _vm._s(_vm.surveyInfo.begin_time))]), _vm._v(" "), _c('p', {
    staticClass: "survey-detail description-font end-time"
  }, [_vm._v("结束时间: " + _vm._s(_vm.surveyInfo.end_time))]), _vm._v(" "), _c('p', {
    staticClass: "survey-detail description-font author"
  }, [_vm._v("发布者: "), _c('span', [_vm._v(_vm._s(_vm.surveyInfo.create_user_name))])]), _vm._v(" "), _c('p', {
    staticClass: "survey-detail preface"
  }, [_vm._v("卷首语")]), _vm._v(" "), _c('p', {
    staticClass: "survey-detail description-font-and-color"
  }, [_c('span', [_vm._v(_vm._s(_vm.surveyInfo.description))])])])]), _vm._v(" "), _c('div', {
    staticClass: "survey-detail-button text",
    on: {
      "click": _vm.detailButtonAction
    }
  }, [_vm._v(_vm._s(_vm._f("surveyStatus")(_vm.surveyInfo.status)))])], 1)
},staticRenderFns: []}

...
exports.default = {
    ...
    methods: {
        getVerificationCode: function getVerificationCode() {
            ...
            if (this.phone === '' || this.phone.length !== 11) {
                MintUI.Toast('请输入正确的手机号');
                return;
            }
            _this.post(_this.api.mySendSmsCode, { 'phone': this.phone, 'companyName': localStorage.company_name, 'type': 'modifyPhone' }).then(function (res) {
                if (res.ok) {
        ...
        confirmButtonAction: function confirmButtonAction() {
            ...
            var _this = this;
            _this.post(_this.api.myInfoModify, { 'type': 'modifyPhone', 'phone': this.phone, 'vcode': this.code }, 'sid').then(function (res) {
                if (res.ok) {
                    if (res.body.code === '0000') {
    ...
    watch: {
        totleTime: function totleTime(oldValue, newValue) {
            if (newValue === 0) {
                this.disabled = false;
                this.clearTimer();
                this.codeBtnTitle = '获取验证码';
            } else {
                this.codeBtnTitle = this.totleTime + '秒后重新获取';
            }
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('not-list-scroll', {
    staticClass: "modify-phone-page"
  }, [_c('mt-field', {
    staticClass: "modify-phone",
    attrs: {
      "label": "手机号",
      "placeholder": "请输入手机号码",
      "type": "number"
  ...
  }, [_c('p', [_vm._v(_vm._s(_vm.codeBtnTitle))])])], 1), _vm._v(" "), _c('div', {

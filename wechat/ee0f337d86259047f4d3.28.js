...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        if (this.examStore.examTabIndex === 0 && this.$route.params.modeType == 'exam_0') {
            this.getExamInfo(this.$route.params.examId).then(function (datas) {
                _this.examInfo = datas.data;
                console.log(_this.examInfo);
            });
        }

        if (this.examStore.examTabIndex === 1 && this.$route.params.modeType == 'simExam_0') {
            this.getSimExamInfo(this.$route.params.examId).then(function (datas) {
                console.log('---------------------模拟考试详情--->', datas);
                _this.examStore.simExamInfo = datas.data;
            });

            this.simExamHistoryList(this.$route.params.examId).then(function (datas) {
                console.log('-----------------模拟考试历史列表--->', datas);
                _this.historyList = datas.data.list;
            });
        } else if (this.$route.params.modeType == 'exam_c') {
                this.getSimExamInfo(this.$route.params.examId).then(function (datas) {
                    console.log('---------------------课程模拟考试详情--->', datas);
                    _this.examStore.simExamInfo = datas.data;
                });

                this.courseExamHistory(this.$route.params.examId).then(function (datas) {
                    console.log('-----------------模拟考试历史列表--->', datas);
                    _this.historyList = datas.data.list;
                });
            }
    ...
    methods: (0, _extends3.default)({
        transToTxt: function transToTxt(val) {
            if (val == 0) {
                return '考试未开始';
            } else if (val == 1) {
                return '开始考试';
        ...
        simTransToTxt: function simTransToTxt(val) {
            if (val == 1) {
                return '开始考试';
            } else if (val == 4) {
                return '考试已过期';
    ...
    }, (0, _vuex.mapActions)(["signUp", 'viewExamResult', 'simCheckStart', 'checkStart', 'simExamHistoryList', 'getExamInfo', 'getSimExamInfo', 'courseExamHistory']), {
        requestAccess: function requestAccess(id, status) {
            var _this2 = this;

            if (status == 1 || status == 2) {
                var type = 'exam_0';
                var identity = null;
                this.$router.push('/getExamInfo/' + id + '/' + type + '/' + identity);
            } else if (status == 7) {
                    this.signUp(id).then(function (datas) {
                        if (datas.data.result == 0) {
                            MintUI.Toast("报名失败");
                        } else if (datas.data.result == 1) {
                            MintUI.Toast("报名成功,等待审核");
                        } else if (datas.data.result == 2) {
                            MintUI.Toast("报名成功");
                        } else if (datas.data.result == 3) {
                            MintUI.Toast("不能重复报名");
                        }
                        _this2.getExamInfo(_this2.$route.params.examId).then(function (datas) {
                            _this2.examInfo = datas.data;
                        });
                    });
                } else if (status == 3 || status == 5 || status == 10) {
                        var data = '-1';
                        var _type = 'exam_0';
                        this.$router.push('/viewExamResult/' + id + '/' + data + '/' + _type);
                    }
        },
        requestSimAccess: function requestSimAccess(id, status) {
            if (status == 1) {
                var type = 'simExam_0';
                var identity = null;
                this.$router.push('/getExamInfo/' + id + '/' + type + '/' + identity);
        ...
        checkAnswer: function checkAnswer(id) {
            var datas = '-1';
            var type = 'simExam_0';
            this.$router.push('/viewExamResult/' + id + '/' + datas + '/' + type);
        }
    }),
    components: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.examStore.examTabIndex === 0) ? _c('div', {
    staticClass: "exam-detail-page"
  }, [_c('div', {
    staticClass: "exam-detail-top"
  }, [_c('img', {
    attrs: {
      "src": _vm._f("getCoverUrl")(_vm.examInfo.cover, 'activity')
    }
  })]), _vm._v(" "), _c('notListScroll', [_c('div', {
    staticClass: "sim-scroll"
  }, [_c('div', {
    staticClass: "exam-detail-main"
  }, [_c('div', {
    staticClass: "main-top"
  }, [_c('p', {
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.examInfo.name))]), _vm._v(" "), _c('p', [_c('span', {
    staticClass: "content"
  }, [_vm._v("开始时间: ")]), _vm._v(" "), _c('span', {
    staticClass: "time"
  }, [_vm._v(_vm._s(_vm.examInfo.begin_time))])]), _vm._v(" "), _c('p', [_c('span', {
    staticClass: "content"
  }, [_vm._v("结束时间: ")]), _vm._v(" "), _c('span', {
    staticClass: "time"
  }, [_vm._v(_vm._s(_vm.examInfo.end_time))])]), _vm._v(" "), _c('p', {
    staticClass: "content"
  }, [_vm._v("考试时长: "), _c('span', [_c('a', [_vm._v(_vm._s(_vm.examInfo.test_time))]), _vm._v(" 分钟")])]), _vm._v(" "), _c('p', {
    staticClass: "content"
  }, [_vm._v("试卷总分: "), _c('span', [_c('a', [_vm._v(_vm._s(_vm.examInfo.score))]), _vm._v(" 分")])]), _vm._v(" "), _c('p', {
    staticClass: "content"
  }, [_vm._v("及格分数: "), _c('span', [_c('a', [_vm._v(_vm._s(_vm.examInfo.pass_score))]), _vm._v(" 分")])]), _vm._v(" "), _c('p', {
    staticClass: "content"
  }, [_vm._v("学分: "), _c('span', [_c('a', [_vm._v(_vm._s(_vm.examInfo.credit))]), _vm._v(" 分")])])]), _vm._v(" "), _c('div', {
    staticClass: "main-bottom"
  }, [_c('p', {
    staticClass: "descriptionTitle"
  }, [_vm._v("考试简介")]), _vm._v(" "), _c('p', {
    staticClass: "content"
  }, [_vm._v(_vm._s(_vm._f("description")(_vm.examInfo.description)))])])])])]), _vm._v(" "), (_vm.examInfo.view_result_style == 2 || _vm.examInfo.view_result_style == 3) ? _c('div', {
    staticClass: "exam-detail-bottom",
    class: {
      'wait-check-exam': _vm.examInfo.status == 6 || _vm.examInfo.status == 4
    }
  }, [_c('a', {
    on: {
      "click": function($event) {
        _vm.requestAccess(_vm.examInfo.id, _vm.examInfo.status)
      }
    }
  }, [_vm._v(_vm._s(_vm.transToTxt(_vm.examInfo.status)))])]) : _vm._e()], 1) : _c('div', {
    staticClass: "exam-detail-page"
  }, [_c('div', {
    staticClass: "exam-detail-top"
  }, [_c('img', {
    attrs: {
      "src": _vm._f("getCoverUrl")(_vm.examStore.simExamInfo.cover, 'activity')
    }
  })]), _vm._v(" "), _c('notListScroll', [_c('div', {
    staticClass: "sim-scroll"
  }, [_c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.examStore.simExamInfo.name))]), _vm._v(" "), _c('p', [_c('span', {
    staticClass: "content"
  }, [_vm._v("开始时间:")]), _vm._v(" "), _c('span', {
    staticClass: "time"
  }, [_vm._v(_vm._s(_vm.examStore.simExamInfo.begin_time))])]), _vm._v(" "), _c('p', [_c('span', {
    staticClass: "content"
  }, [_vm._v("结束时间:")]), _vm._v(" "), _c('span', {
    staticClass: "time"
  }, [_vm._v(_vm._s(_vm.examStore.simExamInfo.end_time))])])]), _vm._v(" "), _c('div', {
    staticClass: "main-bottom"
  }, [_c('p', {
    staticClass: "descriptionTitle"
  }, [_vm._v("考试详情")]), _vm._v(" "), _c('p', {
    staticClass: "content"
  }, [_vm._v(_vm._s(_vm._f("description")(_vm.examStore.simExamInfo.description)))]), _vm._v(" "), _c('p', {
    staticClass: "history-record"
  }, [_vm._v("历史纪录")]), _vm._v(" "), _c('div', {
    staticClass: "history"
  }, [(_vm.historyList.length > 0) ? _c('p', {
    staticClass: "best-record"
  }, [_vm._v("最好记录")]) : _vm._e(), _vm._v(" "), _vm._l((_vm.historyList.slice(0, 1)), function(d, index) {
    return _c('p', {
      key: index,
      staticClass: "history-content"
    }, [_c('span', [_vm._v(_vm._s(d.answer_time))]), _vm._v(" "), _c('span', [_vm._v("正确：")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(d.correct_num))]), _vm._v(" "), _c('a', {
      staticClass: "check-answer",
      on: {
        "click": function($event) {
          _vm.checkAnswer(d.id)
        }
      }
    }, [_vm._v("查看答卷")])])
  }), _vm._v(" "), (_vm.historyList.length > 1) ? _c('p', {
    staticClass: "recent-record"
  }, [_vm._v("最近记录")]) : _vm._e(), _vm._v(" "), _vm._l((_vm.historyList.slice(1)), function(d, index) {
    return _c('p', {
      key: index,
      staticClass: "history-content"
    }, [_c('span', [_vm._v(_vm._s(d.answer_time))]), _vm._v(" "), _c('span', [_vm._v("正确：")]), _vm._v(" "), _c('span', [_vm._v(_vm._s(d.correct_num))]), _vm._v(" "), _c('a', {
    ...
    staticClass: "exam-detail-bottom",
    class: {
      'wait-check-exam': _vm.examStore.simExamInfo.status == 4
    }
  }, [_c('a', {
    on: {
      "click": function($event) {
        _vm.requestSimAccess(_vm.examStore.simExamInfo.id, _vm.examStore.simExamInfo.status)
      }
    }
  }, [_vm._v(_vm._s(_vm.simTransToTxt(_vm.examStore.simExamInfo.status)))])])], 1)])
},staticRenderFns: []}
